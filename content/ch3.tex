...
\par \textbf{3.16} Write a program which uses the minimization operation $\vect{u} ← \vect{v} ⌊ \vect{x}$ to determine the ordering permutation vector $\vect{p} ← \theta_1/(\vect{a} ⍳_1 \vect{b})$.
